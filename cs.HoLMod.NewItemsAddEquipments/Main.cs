...
namespace cs.HoLMod.NewItemsAddEquipments
{
    ...
    public class NewItemsAddTestTool : BaseUnityPlugin
    {
        ...
        public void LoadRelatedResources()
        {
            ...
            resources1.LoadAssetBundle(fileName);//仅在加载第一个资源时加载AssetBundle-newitemsaddequipments
            ...
            // 加载道具-精铁钩的资源包
            string ItemNameKey30 = "JingTieGou";
            ...
            // 加载道具-精钢钩的资源包
            string ItemNameKey47 = "JingGangGou";
