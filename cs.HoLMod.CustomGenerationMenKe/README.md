# 自定义添加门客 CustomGenerationMenKe

在游戏内按F1打开窗口可自定义添加门客。Press F1 in-game to open a window where you can customize and add followers.
...
```shell
BepInEx\config\cs.HoLMod.CustomGenerationMenKe.AnZhi20.cfg
```
