    ...
    internal class LanguageManager
    {
        ...
        private void InitializeTranslations()
        {
            ...
            translations["zh-CN"] = new Dictionary<string, string>
            {
                ...
                { "CategoryModify", "修改" },
                { "SubCategoryField", "沃野" },
                { "SubCategoryVillage", "村落" },
                { "SubCategoryTown", "城镇" },
                { "SubCategoryCamp", "军营" },
                { "SubCategoryLake", "深湖" },
                { "SubCategoryFarm", "农庄" },
                { "SubCategoryForest", "林场" },
                { "SubCategoryMountain", "荒山" }
            };

            // 英文翻译
            translations["en-US"] = new Dictionary<string, string>
            {
                { "WindowTitle", "Fief Editor" },
                { "CategoryAdd", "Add" },
                { "CategoryDelete", "Delete" },
                { "CategoryModify", "Modify" },
                { "SubCategoryField", "Field" },
                { "SubCategoryVillage", "Village" },
                { "SubCategoryTown", "Town" },
                { "SubCategoryCamp", "Camp" },
                { "SubCategoryLake", "Lake" },
                { "SubCategoryFarm", "Farm" },
                { "SubCategoryForest", "Forest" },
                { "SubCategoryMountain", "Mountain" }
            };
        }
